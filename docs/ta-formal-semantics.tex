...
\midrule
$\IRI{hw3{:}hasJoint}$ & $\IRI{cora{:}Robot} \times \IRI{soma{:}Joint}$ & \\
$\IRI{hw3{:}computedForRobot}$ & $\IRI{hw3{:}KinematicComputation} \times \IRI{cora{:}Robot}$ & \\
$\IRI{hw3{:}solvesForTarget}$ & $\IRI{hw3{:}IKComputation} \times \IRI{soma{:}6DPose}$ & \\
...
$\IRI{hw3{:}hasJointState}$ & $\IRI{hw3{:}JointConfiguration} \times \IRI{soma{:}JointState}$ & \\
