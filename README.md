...
```bash
pixi run task1 --student-id <your-student-id>
```
...
```bash
pixi run task1 --student-id <your-student-id> --own
```
...
**Step 3-3.** Now that both solvers are yours, revisit Task 1: `pixi run task1 --student-id <id> --own` grounds and validates **your** execution.
